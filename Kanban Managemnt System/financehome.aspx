<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="financehome.aspx.cs" Inherits="COPY.financehome" %>
                    ...
                    <div class="row">
                        <div class="col-12">
                             <div class="input-group mb-3">
                                 ...
                                 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/finance.aspx">Add Cost</asp:HyperLink>
                                </div>
                     <div class="input-group mb-3">
                         <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/viewcost.aspx">View Cost</asp:HyperLink>
                         </div>
                  <div class="input-group mb-3">
                      </div>
                  <div class="input-group mb-3">
