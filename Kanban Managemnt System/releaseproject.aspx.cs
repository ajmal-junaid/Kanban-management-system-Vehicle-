...
namespace COPY
{
    public partial class releaseproject : System.Web.UI.Page
    {
        connectionk c;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand qqqq = new SqlCommand("insert into Release values(" + int.Parse(Label1.Text) + ",'" + DateTime.Today.ToShortDateString() + "','" + TextBox4.Text + "')", c.open());
            qqqq.ExecuteNonQuery();
            c.close();
